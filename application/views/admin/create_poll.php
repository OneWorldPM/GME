<?php
//print_r($sessions_data->correct_answer);
                            ...
                            <form name="frm_add_Poll" id="frm_add_Poll" method="POST" >
                                ...
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <div class="form-group">
                                            <label class="text-large">Correct Answer 1:</label><br>
                                                ...
                                                <select class="form-control" id="poll_comparisons_id" name="poll_comparisons_id">
                                                    ...
                                                    if (isset($sessions_data->all_other_surveys) && !empty($sessions_data->all_other_surveys)) {
                                                        foreach ($sessions_data->all_other_surveys as $survey) {
                                                            ?>
                                                            <option value="<?= $survey->sessions_poll_question_id ?>" <?=(isset($sessions_data->comparison_with) && $survey->sessions_poll_question_id == $sessions_data->comparison_with->sessions_poll_question_id)?"selected": ""?>><?= $survey->poll_name ?></option>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
