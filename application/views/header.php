...
<html lang="en">
    <head>
        ...
        <title><?=(isset($page_title))?$page_title:'Virtual Conference & Trade Show'?></title>
        <!-- Bootstrap Core CSS -->
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-Z58SQ4MG5Z"></script>
        <script>
...
<!--                                                <li class="sticky_resources_open" data-type="resourcesSticky"><a data-type2="off" class="hoverThemeColour">RESOURCES</a></li>-->
                                    ...
                                    <?php if ($this->router->fetch_class() == 'sessions' && $this->router->fetch_method() == 'view'): ?>
                                        ...
                                        <ul class="main-menu nav navbar-nav navbar-right" id="nav-claim-credit">
                                            <li><a target="_blank" href="https://www.clinicaloptions.com/login?returnUrl=/event/BipolarDepressionWebcast2021Eval"  class="hoverThemeColour">CLAIM CREDIT</a></li>
